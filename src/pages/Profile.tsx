      ...
      <div className="bg-gradient-to-b from-bg-warm to-bg-main pt-12 pb-8 px-5 rounded-b-[40px] shadow-sm relative overflow-hidden">
        ...
        <div className="flex justify-between items-center mb-8 relative z-10">
          <button
            ...
            className="w-10 h-10 rounded-xl bg-card-bg flex items-center justify-center shadow-sm text-ink active:scale-90 transition-all border border-border-subtle"
          >
        ...
        <div className="flex flex-col items-center relative z-10">
          <div className="relative mb-4">
            <div className="w-24 h-24 rounded-full border-4 border-card-bg shadow-xl overflow-hidden flex items-center justify-center bg-card-bg">
              <img
                src={profile.avatar}
                alt="User Avatar"
          ...
          <div className="mt-8 grid grid-cols-3 gap-6 w-full max-w-[320px]">
            <div className="flex flex-col items-center">
              <span className="text-2xl font-black text-ink">2</span>
              <span className="text-[10px] uppercase tracking-wider text-ink-muted/60 font-bold">已领养</span>
            </div>
            <div className="flex flex-col items-center border-x border-border-subtle">
              <span className="text-2xl font-black text-ink">{applications.length}</span>
              <span className="text-[10px] uppercase tracking-wider text-ink-muted/60 font-bold">待申请</span>
            </div>
            <div className="flex flex-col items-center">
              <span className="text-2xl font-black text-ink">{favorites.length}</span>
              <span className="text-[10px] uppercase tracking-wider text-ink-muted/60 font-bold">收藏夹</span>
            </div>
          </div>
      ...
      <div className="px-5 py-6 space-y-8">
        <section>
          ...
          <div className="flex space-x-4 overflow-x-auto scrollbar-hide pb-2 pt-1 -mx-5 px-5">
            ...
            >
              <div className="w-36 h-48 rounded-[28px] bg-border-subtle shadow-none flex flex-col items-center justify-center mb-3 transition-transform group-active:scale-95 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-20 h-20 bg-primary/5 rounded-full blur-2xl -mr-10 -mt-10"></div>
                <div className="absolute bottom-0 left-0 w-16 h-16 bg-primary/5 rounded-full blur-xl -ml-8 -mb-8"></div>
                
                <div className="w-14 h-14 rounded-2xl bg-card-bg shadow-sm flex items-center justify-center text-primary mb-3 z-10 border border-border-subtle">
            ...
            <button
              onClick={() => navigate("/pet/eebd972f-9334-424a-893c-237ef0423c6c")}
            ...
            <button
              onClick={() => navigate("/pet/d36de983-917c-4c98-a3c0-69f7412626dd")}
              className="flex-shrink-0 w-36 group text-left"
            >
              <div className="w-36 h-48 rounded-[28px] overflow-hidden mb-3 shadow-md border border-gray-100 transition-transform group-active:scale-95">
                <img
            ...
            <div className="flex-shrink-0 w-36 flex flex-col items-center justify-center">
              <button 
                ...
                className="w-36 h-48 rounded-[28px] border-2 border-dashed border-border-subtle flex flex-col items-center justify-center bg-card-bg text-ink-muted/40 hover:bg-bg-warm active:scale-95 transition-all mb-3"
              >
        ...
        <section>
          ...
          <button 
            onClick={() => navigate("/adoption/6e475dc4-2511-434f-a068-e0d01fa3b899")}
            className="w-full text-left bg-card-bg rounded-[32px] p-5 shadow-sm border border-border-subtle active:scale-[0.98] transition-transform"
          >
            <div className="flex items-start">
              <div className="w-14 h-14 rounded-2xl overflow-hidden mr-4 flex-shrink-0 border border-border-subtle shadow-sm">
                <img
              ...
              <div className="flex-1">
                ...
                <div className="w-full h-2 bg-border-subtle rounded-full overflow-hidden mb-3">
        ...
        <section>
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <button 
              ...
              className="flex flex-col items-center space-y-2 group active:scale-90 transition-transform"
            >
              <div className="w-14 h-14 rounded-2xl bg-border-subtle flex items-center justify-center text-ink-muted shadow-sm border border-border-subtle">
